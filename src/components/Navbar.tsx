...
import { useModalCartContext } from '@/contexts/ModalCartContext';
import { useModalWishlistContext } from '@/contexts/ModalWishlistContext';
import { useModalSearchContext } from '@/contexts/ModalSearchContext';
                ...
                <div className="container mx-auto h-full">
                    <div className="header-main flex items-center justify-between h-full">
                        ...
                        <Link href={'/'} className='flex items-center lg:hidden'>
                            <div className="heading4">Ecommerce</div>
                        </Link>
                    ...
                    <div className="container h-full">
                        <div className="menu-main h-full overflow-hidden">
                            <div className="heading py-2 relative flex items-center justify-center">
                                ...
                                <Link href={'/'} className='logo text-3xl font-semibold text-center'>Ecommerce</Link>
                            </div>
